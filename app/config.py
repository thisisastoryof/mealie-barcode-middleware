...
EDITABLE_SETTINGS: dict[str, dict[str, Any]] = {
    ...
    "fuzzy_match_threshold": {
        ...
        "hint": "Minimum score (0–100) for a barcode title to be auto-linked to a Mealie item.",
        "min": 0,
        "max": 100,
        "group": "Matching & Sync",
    ...
    "fuzzy_ambiguity_gap": {
        ...
        "hint": "Minimum score gap between the top two matches. Prevents false positives when multiple items score similarly.",
        "min": 0,
        "max": 50,
        "group": "Matching & Sync",
        "section": "Fuzzy Matching",
    ...
    "max_retry_attempts": {
        ...
        "hint": "How many times to retry adding an item to Mealie before marking it as failed.",
        "min": 1,
        "max": 100,
        "group": "Matching & Sync",
        "section": "Scheduling & Retry",
